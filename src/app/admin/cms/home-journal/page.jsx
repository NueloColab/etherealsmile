...
export default function JournalEditor() {
  const { content, loading, saving, saved, save } = useCmsContent('journal')
  ...
  return (
    <div style={{ padding: '2.5rem 2rem', maxWidth: '800px' }}>
      ...
      <h1 style={{ fontFamily: "'Pirata One', 'Playfair Display', cursive", fontSize: '1.8rem', color: '#e94480', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: '2rem' }}>Journal Editor</h1>
