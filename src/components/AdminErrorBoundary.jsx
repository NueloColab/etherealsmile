      ...
      return (
        <div style={{ padding: '2rem', maxWidth: '600px', margin: '2rem auto' }}>
          ...
          <div style={{ marginBottom: '1rem', padding: '1rem', background: 'rgba(255,255,255,0.03)', borderRadius: '8px' }}>
            <p style={{ color: '#e94480', fontSize: '0.8rem', fontWeight: 600, marginBottom: '0.5rem' }}>
              {this.state.error?.message || 'Unknown error'}
            </p>
            {this.state.error?.stack && (
              <pre style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.65rem', overflow: 'auto', whiteSpace: 'pre-wrap', wordBreak: 'break-all' }}>
