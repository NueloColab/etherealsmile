...
import { siteContent } from './src/lib/schema.js'
import { eq } from 'drizzle-orm'

async function restoreParagraphs() {
  // About section — restore full paragraphs
  ...
  // Hattie section — restore full paragraphs
  ...
  if (hattie.length > 0) {
    ...
    console.log("✓ Hattie section updated")
  }

  console.log('Done. Frontend will show full paragraphs on next load.')
  process.exit(0)
}

restoreParagraphs().catch((err) => {
  console.error(err)
  process.exit(1)
})
